<template>
  <div class="post-container">
      ...
      <div slot="posting">
        ...
        <div class="d-flex" style="height:300px;">
          <div class="h-100 flex-container border-left" style="flex:5">
            <div class="w-75">
              <b-form-input class="w-100" v-model="title" placeholder="제목">
              </b-form-input>
              <b-form-textarea
                id="textarea-large"
                size="lg"
      ...
      <div slot="posting" class="room-deal-information-container">
        ...
        <div class="room-picture-notice">
          <ul class="room-write-wrapper">
            ...
            <li>사진 용량은 사진 한장당 10MB 까지 등록이 가능합니다.</li>
          </ul>
        </div>
    ...
    <b-button @click="writePost" variant="primary" class="w-100 mt-3"
      >작성하기</b-button
    >
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    imageUpload() {
      ...
      // 배열을 생성하는데
      // 실제파일을 관리하는 부분, 이미지 privew를 관리하는 부분, index까지 관리하는 배열을 제작
      let num = -1;
