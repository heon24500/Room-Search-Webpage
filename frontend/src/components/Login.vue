              ...
              <div class="modal-container p-4">
                  <div class="h4 modal-header d-flex flex-column align-items-center">
                      ...
                      <div class="w-100 mt-4">
                          <b-form-input class="p-4" placeholder="아이디" v-model="id" type="email"></b-form-input>
                          <b-form-input class="mt-2 p-4" placeholder="비밀번호" v-model="password" type="password"></b-form-input>
                      </div>
